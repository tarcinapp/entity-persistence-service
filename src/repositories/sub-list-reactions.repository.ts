...
export class SubListReactionsRepository extends DefaultCrudRepository<
  ...
  private static response_limit = _.parseInt(process.env.response_limit_list_reaction || "50");
  ...
  async find(filter?: Filter<SubListReactions>, options?: Options) {
    ...
    if (filter?.limit && filter.limit > SubListReactionsRepository.response_limit)
