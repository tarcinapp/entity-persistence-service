 ...
 */
type SelectedKeys = "_kind" | "_name" | "_slug" | "_validFromDateTime" | "_validUntilDateTime" | "_ownerUsers" | "_ownerGroups" | "_viewerUsers" | "_viewerGroups" | "_visibility";

export type SourceAndTargetMetadata = {
  [K in keyof Pick<ListEntityCommonBase, SelectedKeys>]: ListEntityCommonBase[K];
}
